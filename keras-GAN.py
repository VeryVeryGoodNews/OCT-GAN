...
class GAN(object):
    def __init__(self, width = 299, height= 299, channels = 1):
    ...
    def train(self, X_train, epochs=10, batch = 32, save_interval = 200,verbose=2):
...
# train generator
    ...
    def plot_images(self, save2file=False,  samples=16, step=0):
        filename = "./images3/mnist_%d.png" % step
...
if __name__ == '__main__':
    x_url = 'DATA/x_data_1.npy'
    X_train = np.load(x_url) # get xdata
